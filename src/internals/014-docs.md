...
Skip default values in PHPDoc when PHP already shows them in a parameter default, promoted property default, or property
initializer. The declaration is the source of truth, and repeating the value in text can become outdated after code
changes.
