...
All these methods accept a route pattern and a handler.  The route pattern
...
Check ["the middleware"](../structure/middleware.md) guide to learn more
...
This configuration would result in a match with both `/user` and
