...
ответ. Затем вы улучшите решение, используя
[представление](../views/view.md) для построения ответа.
...
middleware](../structure/middleware.md), после чего эмиттер отправляет его
