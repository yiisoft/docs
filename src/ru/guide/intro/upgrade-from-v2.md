...
projects on Yii3 while keeping existing ones on Yii 2.
...
It's a good idea to refactor your Yii 2 project before porting it to
...
Yii3 services are conceptually similar to Yii 2 components, so it's a good
