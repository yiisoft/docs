...
A differenza di Yii 2.0, Yii3 non utilizza controller. Al loro posto,
utilizza i [gestori di richieste](../structure/handler.md) che sono simili
ai controller ma diversi.
