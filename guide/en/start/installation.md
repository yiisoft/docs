...
You can create Yii application using the [Composer](https://getcomposer.org/) package manager.
...
## Creating Yii Application <span id="installing-from-composer"></span>

With Composer installed, you can create application using Yii project template by running the following command
